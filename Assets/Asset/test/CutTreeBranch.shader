Shader "Unlit/CutTreeBranch"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
        _TreeInnerTex ("TreeInnerTex", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _TreeInnerTex;
            float4 _TreeInnerTex_ST;
                ...
                )
            {
                ...
                float PaddingSize =  (instanceID & 1 ? 0 : 1) * 1.0;

                localMat[3][0] = -cutterPositionBuffer[4].x;
                localMat[3][1] = -cutterPositionBuffer[4].y - PaddingSize;
                ...
                // 回転中心を変更
                localMat[3][1] = -cutterPositionBuffer[4].y - 0.5;
                ...
                if (o.test.x - 0.5 < 0.0)
                {
                    v.vertex = half4(-0.25, 0.0, -0.25, 1.0);
                    v.vertex.y = cutterPositionBuffer[4].y * 2.0f;
                }
